...
describe('unordered list tests', () => {
    test('one single unordered list item', () => {
        ...
        expect(parser_1.lex('* Unordered list item')).toStrictEqual(array);
    });
});
...
describe('bold tests', () => {
    test('one single bold text', () => {
        ...
        expect(parser_1.lex('`@bold@`')).toStrictEqual(array);
    });
});
describe('italics tests', () => {
    test('one single italicized text', () => {
        ...
        expect(parser_1.lex('`/italics/`')).toStrictEqual(array);
    });
});
describe('underline tests', () => {
    test('one single underline text', () => {
        ...
        expect(parser_1.lex('`_underline_`')).toStrictEqual(array);
    });
});
describe('highlight tests', () => {
    test('one single highlight text', () => {
        ...
        expect(parser_1.lex('`=highlight=`')).toStrictEqual(array);
    });
});
describe('strikethrough tests', () => {
    test('one single strikethrough text', () => {
        ...
        expect(parser_1.lex('`-strikethrough-`')).toStrictEqual(array);
    });
});
describe('link tests', () => {
    test('one single link text', () => {
        ...
        expect(parser_1.lex('`_link alias_(www.example.com)`')).toStrictEqual(array);
    });
});
describe('image tests', () => {
    test('one single image', () => {
        ...
        expect(parser_1.lex('image:path_to_image.png{}')).toStrictEqual(array);
    });
});
describe('newline tests', () => {
    test('one single newline with text', () => {
        ...
        expect(parser_1.lex('A paragraph ...\nAnd another.')).toStrictEqual(array);
    });
});
describe('indent tests', () => {
    test('one single indent with text', () => {
        ...
        expect(parser_1.lex('A paragraph with an indent: \t.')).toStrictEqual(array);
    });
});
