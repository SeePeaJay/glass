...
describe('unordered list tests', () => {
    test('one single unordered list item', () => {
        ...
        expect(parser_1.default('* Unordered list item')).toStrictEqual(array);
    });
});
describe('ordered list tests', () => {
    test('one single ordered list item', () => {
        ...
        expect(parser_1.default('1. Ordered list item')).toStrictEqual(array);
    });
});
describe('horizontal rule tests', () => {
    test('one single horizontal rule', () => {
        const array = [{ name: 'HORIZONTAL RULE MARKUP', value: '--- ' }];
        expect(parser_1.default('--- ')).toStrictEqual(array);
    });
});
describe('bold tests', () => {
    test('one single bold text', () => {
        ...
        expect(parser_1.default('`@bold@`')).toStrictEqual(array);
    });
});
describe('italics tests', () => {
    test('one single italicized text', () => {
        ...
        expect(parser_1.default('`/italics/`')).toStrictEqual(array);
    });
});
describe('underline tests', () => {
    test('one single underline text', () => {
        ...
        expect(parser_1.default('`_underline_`')).toStrictEqual(array);
    });
});
describe('highlight tests', () => {
    test('one single highlight text', () => {
        ...
        expect(parser_1.default('`=highlight=`')).toStrictEqual(array);
    });
});
describe('strikethrough tests', () => {
    test('one single strikethrough text', () => {
        ...
        expect(parser_1.default('`-strikethrough-`')).toStrictEqual(array);
    });
});
describe('link tests', () => {
    test('one single link text', () => {
        ...
        expect(parser_1.default('`_link alias_(www.example.com)`')).toStrictEqual(array);
    });
});
describe('image tests', () => {
    test('one single image', () => {
        ...
        expect(parser_1.default('image:path_to_image.png{}')).toStrictEqual(array);
    });
});
describe('newline tests', () => {
    test('one single newline with text', () => {
        ...
        expect(parser_1.default('A paragraph ...\nAnd another.')).toStrictEqual(array);
    });
});
describe('indent tests', () => {
    test('one single indent with text', () => {
        ...
        expect(parser_1.default('A paragraph with an indent: \t.')).toStrictEqual(array);
    });
});
